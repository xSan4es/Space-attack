...
public class GameControllerLVL10 : MonoBehaviour, IGameController
{
    ...
    IEnumerator SpawnEnemies()
    {
        ...
        while (true)
        {
            while (true)
            {
                ...
                SearchVariable.pool.Launch_prefab(3, new Vector3(respawnMines.transform.position.x,
                ...
                if (ii % 3 == 0 && creating_amount_transport < need_to_end)
                {
