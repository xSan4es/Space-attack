...
public class GameControllerLVL1 : MonoBehaviour, IGameController
{
    ...
    {
        return new Vector3(
                    SearchVariable.portation.transform.position.x + 3 * Random.Range(0, 9) * camera.ScreenToWorldPoint(new Vector3(Screen.width / 1.1f - SearchVariable.portation.transform.position.x, 0, 0)).x / 14,
